...
define(['dojo/_base/declare',
...
], function(declare, html, lang, array, on, keys, a11yclick, domGeom, _WidgetBase, _TemplatedMixin,
  ...
  var clazz = declare([_WidgetBase, _TemplatedMixin], {
    ...
    _addMenuItem: function(action) {
      ...
      this.own(on(menuItem.domNode, 'keydown', lang.hitch(this, function(evt){
