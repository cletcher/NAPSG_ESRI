...
define([
  ...
  return dojoDeclare([dijitWidgetBase, dijitTemplatedMixin, dijitWidgetsInTemplate], {
    ...
    templateString: '<div>' +
      ...
      '<input tabindex=2 type="text" data-dojo-attach-point="frmtVal" class="formatInput"></input>' +
      ...
      '</div><div class="btnContainer"><div data-dojo-attach-point="applyButton" class="jimu-btn">' +
      '${nls.applyButtonLabel}</div>' +
      '<div data-dojo-attach-point="cancelButton" class="jimu-btn formatCoordCancelButton">' +
